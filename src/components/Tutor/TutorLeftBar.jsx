...
const TutorLeftBar = () => {
  ...
  const AdminLinks = [
    { title: 'My Courses', link: '/tutor/dashboard' },
    { title: 'Search Courses', link: '/tutor/search' },
    { title: 'Manage Material', link: '/tutor/material' },
    { title: 'Manage Courses', link: '/tutor/courses' },
  ];
